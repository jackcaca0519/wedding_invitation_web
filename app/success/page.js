        ...
        <>
            <div className="h-100 attending_area p-0 d-flex align-items-center overflow-hidden">
                <Container className="main_attending_area" maxWidth="sm" style={{padding: '20px'}}>
                    ...
                    <Card className='p-3' style={{position:'relative', height: 500, boxShadow: '0 0 20px 0px #c5c5c5', backgroundImage: "url('/img/custom/107_5360.jpg')", backgroundPosition: 'center',backgroundSize: 'cover'}}>
                                ...
                                <div className="px-md-5">
                                    ...
                                    <div className="py-1 px-md-4 d-flex justify-content-center">
                                        <div className="text-left">
                                            <h4 className="text-uppercase font-weight-normal m-0 text-white" style={{letterSpacing: 2}}>時間：2025.02.22 17:30</h4>
